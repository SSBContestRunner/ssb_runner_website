...
<section class="place-items-center w-full bg-primary-400/8">
    <div class="container flex flex-col md:flex-row md:items-center gap-2">
        ...
        <div class="mb-4 md:mb-0 px-2 md:px-0">
            <h1 class="text-xl font-semibold">{t('download_area-title')}</h1>
            <div class="mb-8">
                <span>{t('download_area-subtitle')}</span>
            </div>
            <button
                class="bg-primary-400 text-white px-4 py-2 rounded-md cursor-pointer
                hover:outline-2 outline-offset-1 outline-primary-400"
                onclick={() => toPage("download")}>{t('download_area-btn')}</button
            >
        </div>
    </div>
</section>
<section class="place-items-center w-full">
    <div class="container py-4 px-2 md:px-0">
        <h1 class="text-2xl font-semibold">{t('dev_team-title')}</h1>
...
<section class="place-items-center w-full bg-primary-400/8">
    <div class="container py-4 px-2 md:px-0">
        <h1 class="text-2xl font-semibold">{t('sponser-title')}</h1>
